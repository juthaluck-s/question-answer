<?php
$queryType_CustomerPower = $condb->prepare("
SELECT tp.id_topic, tp.type_topic, tp.topic, tp.dateSave, tp.views, tp.reply,
       us.firstname, us.lastname
FROM tbl_topic tp
JOIN tbl_user us ON tp.id_member = us.id_member
WHERE tp.type_topic = 'Customer Power'
ORDER BY tp.dateSave DESC;
");
$queryType_CustomerPower->execute();
$type_ctm_pw = $queryType_CustomerPower->fetchAll();
?>
